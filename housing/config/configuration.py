...
class configuration:
    ...
    def get_data_validation_config(self)->DataValidationConfig:
        try:
            ...
            data_validation_atrifact_dir=os.path.join(
                artifact_dir,
            ...
            report_file_path = os.path.join(data_validation_atrifact_dir,
            data_validation_config[DATA_VALIDATION_REPORT_FILE_NAME_KEY])

            report_page_file_path = os.path.join(data_validation_atrifact_dir,
